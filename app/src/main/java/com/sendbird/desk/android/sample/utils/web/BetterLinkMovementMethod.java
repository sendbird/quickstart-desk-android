...
public class BetterLinkMovementMethod extends LinkMovementMethod {
     ...
     */
    static BetterLinkMovementMethod newInstance() {
     ...
     * @return The registered {@link BetterLinkMovementMethod} on the TextViews.
     */
    static BetterLinkMovementMethod linkifyHtml(TextView... textViews) {
     ...
     * @return The registered {@link BetterLinkMovementMethod} on the TextViews.
     */
    static BetterLinkMovementMethod linkify(int linkifyMask, ViewGroup viewGroup) {
        BetterLinkMovementMethod movementMethod = newInstance();
     ...
     * @return The registered {@link BetterLinkMovementMethod} on the TextViews.
     */
    static BetterLinkMovementMethod linkifyHtml(ViewGroup viewGroup) {
     ...
     * @return The registered {@link BetterLinkMovementMethod} on the TextViews.
     */
    static BetterLinkMovementMethod linkify(int linkifyMask, Activity activity) {
     ...
     * @return The registered {@link BetterLinkMovementMethod} on the TextViews.
     */
    static BetterLinkMovementMethod linkifyHtml(Activity activity) {
